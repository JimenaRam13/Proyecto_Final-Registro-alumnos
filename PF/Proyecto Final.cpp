/*********************************Presentación**********************************
  ...
  Descripción: En este programa el usuario va a poder ingresar los datos de 5
...
FILE *Archivo; //Se crea un puntero para el recopilamiento de los datos
...
void seleccion(){
    ...
    switch(opcion_alumno){
        ...
        case 5:
        Archivo = fopen("Alumno5.txt","wt+"); //Se abre archivo
        break;
    }
    if (Archivo == NULL){
        printf("El archivo no existe.\n"); //Error si pone dato inválido
    }
}
...
void ingreso_alumno(){
    ...
    getline(cin, Al1.Nombre_alumno); //Guardar en la estructura
...
void registro_materia(){
    ...
    }while(M1.Calificacion < 0 || M1.Calificacion > 100); //Bucle hasta poner valor válido
